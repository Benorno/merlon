                ...
                <div class="row p-3">
                    ...
                    <div class="col mb-3 text-center">
                        ...
                        <div class="btn-group" role="group" aria-label="Visibility">
                            ...
                            <label
                                class="btn btn-outline-danger me-3 rounded-0 border-2 {{ $subcategory->is_hidden == '1' ? 'active' : '' }}"
                                for="hidden">Hidden</label>

                            <input type="radio" class="btn-check" name="is_hidden" id="visible" value="0"
                                {{ $subcategory->is_hidden == '0' ? 'checked' : '' }}>
                            <label
                                class="btn btn-outline-primary rounded-0 border-2 {{ $subcategory->is_hidden == '0' ? 'active' : '' }}"
                    ...
                    <div class="col mb-3">
                        ...
                        <input type="file" name="subcategory_photo" id="subcategory_photo"
                            class="form-control rounded-0 border-2 border-dark" value="{{ old('subcategory_photo', $subcategory->subcategory_photo) }}">
                    </div>
